            ...
            <form action="">
                ...
                <div className="info__tab">
                    <div className="info__tab-container">
                        <span className="info__tab-label">
                            {t("description.descr")}
                        </span>
                    </div>
                </div>
                <div className="info__tabs-body">
                    <div className="info__detail-list">
                        <div className="info__detail-item">
                            <div className="info__detail-item-title">
                                {t("description.madeIn")}
                            </div>
                            <div className="info__detail-item-space"></div>
                            <div className="info__detail-item-value">
                                {t("description.inArmenia")}
                            </div>
                        </div>
                    </div>
                </div>
