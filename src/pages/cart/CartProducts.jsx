      ...
      {products?.length ? 
       ...
       {filteredProducts?.length ? (
         <Table sx={{ minWidth: 650 }} aria-label="simple table">
           <TableHead>
             <TableRow>
               <TableCell style={titleStyle} align="center">{t('description.image')}</TableCell>
               <TableCell style={titleStyle} align="center">{t('description.product1')}</TableCell>
             ...
             {filteredProducts.map((row) =>
               cartItems[row.id] ? (
                 ...
                 >
                   ...
                   <TableCell align="center">
                     <DeleteIcon
                       style={{ color: "#a2959c",  cursor: "pointer",}}
                       onClick={() =>
                         dispatch(
                           removeFromCart({
                             productId: `${row.id}`,
