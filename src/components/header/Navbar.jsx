...
const Navbar = ({ changeLanguage, t }) => {
  ...
  return (
    <AppBar className="navbar" sx={{ backgroundColor: 'white', color: 'black' }} position="static">
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <IconButton size="large" component={Link} to="/cart">
              <Badge
                badgeContent={Object.keys(cartItems).length ? Object.keys(cartItems).length : null}
                color="error">
                <ShoppingCart />
              </Badge>
            </IconButton>
            ...
            <IconButton size="large" component={Link} to="/favorites">
              <Badge
                badgeContent={wishlistItems.length ? wishlistItems.length : null}
                color="error">
                <Favorite />
              </Badge>
            </IconButton>
